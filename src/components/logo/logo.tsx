...
import { LogoSection } from '../../enums';
import { BaseProps } from '../../types';
import { StyledPath } from './logo.styled';
  ...
  return (
    ...
    >
      <StyledPath
        ...
        active={
          activeSection === LogoSection.LETTER_L ||
          activeSection == null
        }
      />
      <StyledPath
        ...
        interactive={interactive}
        active={
          activeSection === LogoSection.REVERSE_LETTER_L ||
          activeSection == null
        }
      />
      <StyledPath
