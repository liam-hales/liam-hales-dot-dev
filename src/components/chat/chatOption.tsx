...
/**
 * The `ChatOption` component props
 */
...
/**
 * Used to render a chat option which displays the option name
 * alongside the toggle to set the option on/off state
 *
 * @param props The component props
 * @returns The `ChatOption` component
 */
const ChatOption: FunctionComponent<Props> = ({ className, text, isOn, onChange }): ReactElement<Props> => {
  return (
